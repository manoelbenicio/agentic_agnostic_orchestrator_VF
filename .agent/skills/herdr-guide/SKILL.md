---
name: herdr-guide
description: "Guide humans through Herdr setup, concepts, and troubleshooting. Use when a user asks about Herdr — what it is, how to install it, how to configure it, or how to diagnose problems. This is a teaching skill, not an operational one."
license: MIT
metadata:
  author: herdr
  version: "1.0"
