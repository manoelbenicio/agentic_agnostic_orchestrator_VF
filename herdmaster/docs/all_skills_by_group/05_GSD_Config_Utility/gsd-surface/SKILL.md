...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `~/.gemini/antigravity/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=~/.gemini/antigravity/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=~/.gemini/antigravity/commands/gsd
AGENTS_DIR=~/.gemini/antigravity/agents
```
...
<execution_context>
Surface state file: `~/.gemini/antigravity/skills/.gsd-surface.json`
Install profile marker: `~/.gemini/antigravity/skills/.gsd-profile`
Engine module: `~/.gemini/antigravity/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `~/.gemini/antigravity/gsd-core/bin/lib/clusters.cjs`
</execution_context>
